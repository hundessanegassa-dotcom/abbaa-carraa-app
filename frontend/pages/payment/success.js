...
export default function PaymentSuccess() {
  ...
  const { tx_ref, pool_id, contribution_id } = router.query;
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12">
      ...
      <div className="container mx-auto px-4 max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl p-8 text-center transform transition-all duration-500 animate-slideUp">
          ...
          <p className="text-gray-500 mb-6">
            Your contribution to <strong className="text-green-600">{poolName}</strong> has been confirmed.
          </p>

          <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-5 mb-6 text-left border border-green-100">
            <p className="text-xs text-gray-500 uppercase tracking-wide">What happens next?</p>
            <div className="space-y-3 mt-3">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                  <span className="text-sm">1</span>
                </div>
                <p className="text-sm text-gray-700">Your entry has been recorded</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                  <span className="text-sm">2</span>
                </div>
                <p className="text-sm text-gray-700">When pool reaches target, winner is randomly selected</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                  <span className="text-sm">3</span>
                </div>
                <p className="text-sm text-gray-700">Winner receives 100% of target amount</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="bg-gradient-to-r from-green-600 to-teal-600 text-white py-3.5 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 hover:shadow-lg transition-all duration-200 touch-target"
            >
