...
export default function CreateMerkatoPool() {
  ...
  const handleCreatePool = async () => {
    ...
    try {
      ...
      router.push('/admin/merkato-pools');
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-green-600 to-teal-600 px-6 py-4">
                ...
                <p className="text-green-100 text-sm">Create high-value prize pools for Merkato traders</p>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 bg-gradient-to-r from-green-600 to-teal-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition disabled:opacity-50"
                  >
