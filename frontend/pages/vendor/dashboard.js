...
export default function VendorDashboard() {
  ...
  return (
    <DashboardLayout title="Vendor Dashboard" subtitle="List your products and reach customers" icon="🏭" bgGradient="from-purple-600 to-pink-600" user={user} profile={profile}>
