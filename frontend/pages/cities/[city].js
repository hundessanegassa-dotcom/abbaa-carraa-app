...
import { TIERS, TIER_IDS, getDrawScheduleText } from '../../lib/seatPrograms';
        ...
        <div className="min-h-screen bg-gray-100">
          ...
          {showCheckout && selectedTier && (
            <SeatCheckout
              ...
              poolName={`${selectedTier.icon} ${language === 'am' ? selectedTier.labelAm : selectedTier.labelEn} - ${cityName} VIP`}
              user={user}
              language={language}
