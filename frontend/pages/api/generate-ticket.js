// pages/api/generate-ticket.js - Server-side ticket generation
...
export default async function handler(req, res) {
  ...
  try {
    const { participant, programType, tier, seatNumbers, ticketNumber, amount, prize, language = 'am', isVerified = true } = req.body;

    // Validate required fields
    if (!programType || !ticketNumber) {
    ...
    const svgTemplate = `
      <svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
        ...
        <text x="430" y="378" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="#1f2937">TBD</text>
