    ...
    >
      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold text-yellow-800 text-sm">Your Agent Dashboard</h3>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <span className="text-[10px] bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full">✓ Earn 10%</span>
