...
export default function AgentDashboard() {
  ...
  return (
    <DashboardLayout title="Agent Dashboard" subtitle="Manage your pools and track earnings" icon="🤝" bgGradient="from-yellow-600 to-orange-600" user={user} profile={profile}>
