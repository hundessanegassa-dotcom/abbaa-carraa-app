    ...
    return (
      <>
        <Head>
          ...
          <meta name="description" content="Enter verification code to complete registration" />
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Create your Abbaa Carraa account with phone number" />
        <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
      </Head>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 py-12 px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Join Abbaa Carraa today</p>
          </div>
          
          {/* Phone Registration - Primary Method */}
          <div className="bg-green-50 rounded-xl p-4 mb-6">
            <div className="flex items-center gap-2 mb-3">
              <span className="text-green-600 text-lg">📱</span>
              <h3 className="font-bold text-green-800">Sign up with Phone</h3>
              <span className="bg-green-200 text-green-800 text-xs px-2 py-0.5 rounded-full ml-auto">Fast & Easy</span>
            </div>
