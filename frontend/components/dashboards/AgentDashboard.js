...
export default function AgentDashboard() {
  ...
  return (
    <DashboardLayout title="Agent Dashboard" subtitle="Create pools and earn 10% commission" icon="🤝" bgGradient="from-yellow-600 to-orange-600" user={user} profile={profile}>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6"><div className="bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl p-6 text-white"><h3 className="text-xl font-bold mb-3">💰 How You Earn</h3><ul className="space-y-2 text-sm"><li>✓ 10% commission on every pool</li><li>✓ Paid when pool completes</li><li>✓ Create high-value prizes</li><li>✓ Offer discounts to participants</li></ul><Link href="/create-pool" className="inline-block mt-4 bg-white text-orange-600 px-4 py-2 rounded-full text-sm font-semibold">Create Pool →</Link></div></div>
      </div>
    </DashboardLayout>
  );
}
