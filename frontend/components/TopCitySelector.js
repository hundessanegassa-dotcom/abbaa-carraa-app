...
// Complete list of ALL Ethiopian cities (no "coming soon" - ALL AVAILABLE)
...
export default function TopCitySelector() {
  ...
  const handleCitySelect = (city) => {
    ...
    } else if (router.query.city !== city.id) {
      router.push(`/cities/${city.id}`);
    }
  };
  ...
  return (
    <div className="relative">
      {/* City Selector Button - Grey Theme */}
      <button
          ...
          <div className="absolute top-full right-0 mt-2 w-80 sm:w-96 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 z-50 overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-800 bg-gray-900">
              ...
              <p className="text-xs text-gray-400 mt-1">
                {allEthiopianCities.length}+ Ethiopian cities available • All fully activated
              </p>
            </div>
            ...
            <div className="p-3 border-t border-gray-800 bg-gray-900 text-center">
              <p className="text-[10px] text-gray-500">
                ✓ All cities fully activated • No restrictions • Join any city VIP program
              </p>
            </div>
          </div>
        </>
