          ...
          <div className="md:w-1/3 h-48 md:h-auto relative bg-black/20 flex items-center justify-center">
            {currentProduct.image_url ? (
              ...
              <div className="text-center p-6">
                ...
                <p className="text-sm opacity-80">{t('moving_ad.win_this_prize') || 'Win this prize!'}</p>
              </div>
            )}
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <h3 className="text-2xl font-bold mb-2">{t('moving_ad.special_promotion')}</h3>
              <p className="text-sm opacity-90">{t('moving_ad.special_promotion_desc')}</p>
            </div>
            <div className="flex-1">
              <span className="text-5xl mb-3 block">🏆</span>
              <h3 className="text-2xl font-bold mb-2">{t('common.winners')}</h3>
              <p className="text-sm opacity-90">{t('moving_ad.winners_circle_desc')}</p>
            </div>
            <div>
              <Link href="/register">
