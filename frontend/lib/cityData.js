// lib/cityData.js - COMPLETE CITY DATA FOR ALL 94 ETHIOPIAN CITIES + UNLISTED SUPPORT
// This file is used by pages/cities/index.js, pages/cities/[city].js, and pages/index.js
...
export const cityData = {
  ...
  'abiy-addi': { 
    name: 'አቢይ አዲ | Abiy Addi', 
    slogan: 'የማዕከላዊ ትግራይ ከተማ', 
    businesses: '2,500+', 
    workers: '10,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የማዕከላዊ ትግራይ ከተማ', 
    population: '30K+', 
    region: 'Tigray' 
  },
  'wukro': { 
    name: 'ውቅሮ | Wukro', 
    slogan: 'የምስራቅ ትግራይ ከተማ', 
    businesses: '3,000+', 
    workers: '12,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የምስራቅ ትግራይ ከተማ', 
    population: '50K+', 
    region: 'Tigray' 
  },
  ...
  'injibara': { 
    name: 'እንጅባራ | Injibara', 
    slogan: 'የአዊ ዞን ዋና ከተማ', 
    businesses: '3,000+', 
    workers: '10,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የአዊ ዞን ዋና ከተማ', 
    population: '40K+', 
    region: 'Amhara' 
  },
  'lalibela': { 
  ...
  'mojo': { 
    name: 'ሞጆ | Mojo', 
    slogan: 'የሎጂስቲክስ እና የኢንዱስትሪ ከተማ', 
    businesses: '3,000+', 
    workers: '12,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🚛', 
    product: 'ሎጂስቲክስ, ኢንዱስትሪ', 
    description: 'የሎጂስቲክስ እና የኢንዱስትሪ ከተማ', 
    population: '50K+', 
    region: 'Oromia' 
  },
  'dodola': { 
    ...
    icon: '🏔️', 
    product: 'ቱሪዝም, ግብርና', 
    description: 'የባሌ ተራራ መግቢያ', 
    population: '30K+', 
    region: 'Oromia' 
  },
  'gera': { 
    name: 'ጌራ | Gera', 
    slogan: 'የቡና ማምረቻ አካባቢ', 
    businesses: '2,000+', 
    workers: '8,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '☕', 
    product: 'ቡና', 
    description: 'የቡና ማምረቻ አካባቢ', 
    population: '25K+', 
    region: 'Oromia' 
  },
  'agaro': { 
  ...
  'lemu': { 
    name: 'ለሙ | Lemu', 
    slogan: 'የእህል እርሻ አካባቢ', 
    businesses: '2,000+', 
    workers: '8,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🌾', 
    product: 'እህል', 
    description: 'የእህል እርሻ አካባቢ', 
    population: '20K+', 
    region: 'Oromia' 
  },
  'hagere-mariam': { 
    name: 'ሀገረ ማርያም | Hagere Mariam', 
  ...
  'wachile': { 
    name: 'ዋቺሌ | Wachile', 
    slogan: 'የእንስሳት እርባታ አካባቢ', 
    businesses: '2,000+', 
    workers: '8,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🐪', 
    product: 'እንስሳት', 
    description: 'የእንስሳት እርባታ አካባቢ', 
    population: '20K+', 
    region: 'Oromia' 
  },
  'goba': { 
  ...
  'dinsho': { 
    name: 'ዲንሾ | Dinsho', 
    slogan: 'የባሌ ተራራ ብሔራዊ ፓርክ መግቢያ', 
    businesses: '2,000+', 
    workers: '8,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏞️', 
    product: 'ቱሪዝም', 
    description: 'የባሌ ተራራ ብሔራዊ ፓርክ መግቢያ', 
    population: '20K+', 
    region: 'Oromia' 
  },
  ...
  'ferfer': { 
    name: 'ፌርፌር | Ferfer', 
    slogan: 'የኢትዮ-ሶማሊያ ድንበር ከተማ', 
    businesses: '2,000+', 
    workers: '8,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🛣️', 
    product: 'ንግድ, ድንበር', 
    description: 'የኢትዮ-ሶማሊያ ድንበር ከተማ', 
    population: '30K+', 
    region: 'Somali' 
  },
  ...
  'mizan-teferi': { 
    name: 'ሚዛን ተፈሪ | Mizan Teferi', 
    slogan: 'የቤንች ማጂ ዞን ዋና ከተማ', 
    businesses: '3,000+', 
    workers: '12,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የቤንች ማጂ ዞን ዋና ከተማ', 
    population: '45K+', 
    region: 'South' 
  },
  'teppi': { 
  ...
  'welkite': { 
    name: 'ወልቂጤ | Welkite', 
    slogan: 'የጉራጌ ዞን ዋና ከተማ', 
    businesses: '4,000+', 
    workers: '15,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የጉራጌ ዞን ዋና ከተማ', 
    population: '50K+', 
    region: 'South' 
  },
  ...
  'metekel': { 
    name: 'ሜተከል | Metekel', 
    slogan: 'የሜተከል ዞን ዋና ከተማ', 
    businesses: '2,500+', 
    workers: '10,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የሜተከል ዞን ዋና ከተማ', 
    population: '35K+', 
    region: 'Benishangul' 
  },
  'dibate': { 
    name: 'ዲባቴ | Dibate', 
    slogan: 'የቤንሻንጉል ክልል ከተማ', 
    businesses: '2,000+', 
    workers: '8,000+', 
    color: 'from-gray-700 to-gray-900', 
    icon: '🏔️', 
    product: 'ንግድ, ግብርና', 
    description: 'የቤንሻንጉል ክልል ከተማ', 
    population: '25K+', 
    region: 'Benishangul' 
  },
...
export function getAllCities() {
  return Object.keys(cityData).map(key => ({
    ...
    population: cityData[key].population || 'N/A'
  }));
}
...
export function getCitiesByRegion(region) {
  return getAllCities().filter(city => city.region === region);
}

// ✅ FUNCTION TO GET CITY COUNT
